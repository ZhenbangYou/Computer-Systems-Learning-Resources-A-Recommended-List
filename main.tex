...
\centerline{\large{Last Updated: August 21, 2022}}
...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \item \emph{ML}, the ancestor of \emph{OCaml}, is a programming language that won his creator a Turing Award, for it is ``the first language to include polymorphic type inference together with a type-safe exception-handling mechanism".
    \end{enumerate}
    ...
    \begin{itemize}
        ...
        \item Notes:
        \begin{enumerate}
            \item OCaml on Windows is not recommended.
        \end{enumerate}
    \end{itemize}
    ...
    \begin{itemize}
        ...
        \begin{enumerate}
            ...
            \item Other learning materials from F\# Software Foundation:\\
            \href{https://fsharp.org/learn/}{https://fsharp.org/learn/}
            \item Other learning materials from Microsoft:\\
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \begin{enumerate}
            ...
            \begin{itemize}
                \item Personally, I recommend \emph{Scala} + \emph{Rust}.
